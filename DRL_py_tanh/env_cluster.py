...
touch finished.txt""")
    ...
    def run_trajectory(self, buffer_counter, proc, results, sample, action_bounds):
        ...
        os.popen(f'cp -r ./env/base_case/agentRotatingWallVelocity/* {traj_path}/ && '
                 ...
                 f'sed -i "s/logStdMax.*/logStdMax       {-0.35};/g" {traj_path}/0/U &&'
                 ...
                 f'sed -i "s/logStdMax.*/logStdMax       {-0.35};/g" {traj_path}/0.org/U &&'
        ...
        for i in range(core_count):
            ...
            os.popen(f'cp -r ./env/base_case/baseline_data/Re_100/processor{i}/{time_string}025 {traj_path}/processor{i}/{time_string}025 &&'
                 ...
                 f'sed -i "s/logStdMax.*/logStdMax       {-0.35};/g" {traj_path}/processor{i}/0.00025/U &&'
                 f'sed -i "s/logStdMax.*/logStdMax       {-0.35};/g" {traj_path}/processor{i}/{time_string}025/U')
